...
% ByteMobile
\begin{tabular*}{6.10in}{l@{\extracolsep{\fill}}r}
\textbf{Senior Software Engineer}&Citrix Systems (ByteMobile until 2012)\\
2010-present&Champaign, IL\\
\end{tabular*}
\begin{packed_item}
\item
Developed systems for dynamic optimization, caching and analysis of MPEG4, FLV
and RTMP video sessions for mobile networks.
\item
Drove several internal initiatives for software improvement such as test-driven
development, static code analysis and randomized black-box testing.
\item
Performed debugging of C++ systems from core files and live systems in dbx/gdb,
black-box testing with perl, bash and python scripts and network trace analysis
with snoop and tcpdump.
\end{packed_item}
...
\begin{packed_item}
\item
Responsible for several Java packages including network test suite
...
Programming Languages:&C++, Java, C, perl, bash, python\\
