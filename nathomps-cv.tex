...
\newcommand{\flattenlist}{\vspace{-4mm}}
...
\title{\textbf{PhD}, Computer Science}
\dates{2010}
\location{Urbana, IL}
\begin{position}
\flattenlist
...
\title{\textbf{BS with Honors}, Computer Science}
\dates{2001}
...
\employer{Citrix ByteMobile}
\title{\textbf{Senior Software Engineer II}}
\dates{2010-present}
...
video.
\item
Re-architect software modules for increased performance (30\% reduction
...
% MOBIUS
\employer{Advisor: Prof. Robin Kravets}
...
\item
Developed a congestion control protocol for intermittently-connected networks
...
% T-Labs
\employer{Deutsche Telekom Laboratories}
...
% DPRG
\employer{DPRG Research Group, Prof. Indranil Gupta}
\title{\textbf{Graduate Research Assistant}}
\dates{2004-2005}
\location{University of Illinois at Urbana-Champaign}
\begin{position}
...
% reuse format from initial professional experience

% NCSA
\employer{National Center for Supercomputing Applications}
\title{\textbf{Graduate Research Programmer}}
\dates{2004-2005}
\location{Urbana, IL}
\begin{position}
...
% Pablo
\iffalse
\employer{Pablo Research Group, Prof. Dan Reed}
\title{\textbf{Graduate Research Assistant}}
\dates{2003-2004}
\location{University of Illinois at Urbana-Champaign}
\begin{position}
...
\title{\textbf{Member Technical Staff, Java}}
\dates{2001-2003}
...
% Bosch
%\employer{Robert Bosch GmbH FV/FLI (R\&D/Systems Laboratory)}
\employer{Robert Bosch (R\&D/Systems Laboratory)}
\title{\textbf{Undergraduate Intern}}
\dates{Summer 2000}
...
\textit{Primary}: C++, Java, C, perl, bash&
\textit{Secondary}: python, JavaScript, HTML\\
